            ...
            <div class="row">
                            ...
                            <div class="card-header ">
                                ...
                                <nav class="navbar navbar-expand-lg navbar-light bg-dark ">
                                    ...
                                    <form style="width: 100%;" class="form-inline my-2 my-lg-0">
                                        <input name="first_name" id="first_name" style="width: 24%;"
                                               class="form-control mr-sm-2" type="text" placeholder="First name">.....
                                        <input name="last_last" id="last_name" style="width: 24%;"
                                               class="form-control mr-sm-2" type="text" placeholder="Last name">..........

                                        <select name="gender" id="gender" class="form-control mr-sm-2">
                                        ...
                                        <select name="major" id="major" class="form-control mr-sm-2">
                                            <option> MAJOR</option>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card ">
                            <div class="card-header ">
                                <h5 class="card-title"> Serch Users</h5>
                            </div>
                            ...
                            <div style="padding: 15px;">
                                ...
                                <table class="table">
                                    ...
                                    <% int i = 1;%>
                                    <tbody>
                                    <c:forEach items="${seaerchList}" var="users">
                                        <tr>
                                            <th><% out.print(i);%></th>
