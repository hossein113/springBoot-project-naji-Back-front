                            ...
                            <div class="row">
                                ...
                                <div class="col-7 col-md-8">
                                    <div class="numbers">
                                        ...
                                        <p class="card-title">" ${countTeacher} "
                                        <p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-7 col-md-8">
                                    <div class="numbers">
                                        ...
                                        <p class="card-title">" ${countStudent} "
                                        <p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-7 col-md-8">
                                    <div class="numbers">
                                        ...
                                        <p class="card-title">" ${countReject} "
                                        <p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-7 col-md-8">
                                    <div class="numbers">
                                        ...
                                        <p class="card-title">" ${countPending} "
                                        <p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-7 col-md-8">
                                    <div class="numbers">
                                        ...
                                        <p class="card-title">" ${countActive} "
                                        <p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card ">
                        ...
                        <div style="padding: 15px;">
                            ...
                            <table class="table">
                                ...
                                <c:forEach items="${pendingList}" var="users">
                                    <tr>
                                        <th><% out.print(i);%></th>
                                        ...
                                        <th>
                                            ...
                                            <button type="button" id="id_active" value="${users.id}"
                                                    class="btn btn-success" onclick="activeStatus()">
                                                Active
                                            </button>


                                            <button class="btn btn-danger" id="id_reject" value="${users.id}"
                                    ...
                                    <div class="container text-center text-md-start mt-5">
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                                                ...
                                                <p><i class="fas fa-phone me-3 text-secondary"></i> +98 9196309368</p>
                                            </div>
                                            <!-- Grid column -->
                                        </div>
                                        <!-- Grid row -->
...
<script>
    function reject() {
        ...
        id = document.getElementById('id_reject').value,

            $.ajax({

                type: 'post',
                url: '/api/admin/reject-status?id=' + id,
...
<script>
    function activeStatus() {
        ...
        id = document.getElementById('id_active').value,

            $.ajax({

                type: 'post',
                url: '/api/admin/active-status?id=' + id,
                contentType: 'application/json',
                success: function (response) {
                    window.location.href = '/admin/dashboard'
